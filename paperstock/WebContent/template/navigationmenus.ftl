 <ul class="nav navbar-nav side-nav">
                    <li class="<#if navpage?? && navpage=="dashboard">active</#if>">
                        <a href="navigation?menu=dashboard"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li class="<#if navpage?? && navpage=="purchase">active</#if>">
                        <a href="navigation?menu=purchase"><i class="fa fa-fw fa-bar-chart-o"></i> Purchase</a>
                    </li>
